...
*/
     imagesetpixel($im,rand()%58,rand()%28,$black);    //加入点状干扰素
     imagesetpixel($im, rand()%58 , rand()%28 , $red);
     imagesetpixel($im, rand()%58 , rand()%28 , $gray);
//     imagearc($im, rand()%158, rand()%128, 20, 20, 75, 170, $black);
   //  imageline($im, rand()%200, rand()%200, rand()%200, rand()%200, $red);
}
