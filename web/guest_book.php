...
<META content=all name=robots><LINK href="index.files/style.css" 
...
<TABLE cellSpacing=0 cellPadding=0 width=1003 border=0>
  ...
  <TR>
    <TD width=52></TD>
    <TD width=900 background=index.files/user3-bg.gif>
      <TABLE height=70 cellSpacing=0 cellPadding=0 width=900 border=0>
        <TBODY>
        <TR>
            ...
            <TABLE class="banner userdesign" cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                <TD><object classid=clsid:D27CDB6E-AE6D-11cf-96B8-444553540000 
                  ...
                  <param name="Src" value="index.files/banner.swf">
...
<TABLE cellSpacing=0 cellPadding=0 width=1003 border=0>
                ...
                <TD>
                  ...
                  <TABLE class="HomeAreaA HomeAreaA05 vote" cellSpacing=0 cellPadding=0 width="100%" border=0>
                    ...
                    <TR>
                      <TD>
                        <DIV 
                        class="HomeAreaA HomeAreaA05 VoteDes">
                          <blockquote>
                            <p>&nbsp;</p>
                          </blockquote>
                        </DIV></TD></TR>
                    ...
                    <TR>
                      <TD align=left><INPUT type=radio value=2 
                        name=option1>
                        </TD>
                    </TR>
                    <TR>
                      <TD align=left><INPUT type=radio value=3 
                        name=option1></TD></TR>
                    <TR>
      ...
      <TABLE style="BORDER-COLLAPSE: collapse" borderColor=#a59c7b height="100%" width=670 background="" border=1>
        ...
        <TR>
          <TD vAlign=top align=middle background="">
			...
			Your phone num <?php echo $_POST["phone"]; ?> <br/>
			Your qq num <?php echo $_POST["qq"]; ?> <br/>
			Your content  <?php echo $_POST["content"]; ?> <br/>
			</TABLE>
		   </TD>
		</TR>
        <TR>
  ...
  <TR>
    ...
    <TD width=210 background="" height=25></TD>
    <TD width=20 background="" height=25></TD>
...
<TABLE height=107 cellSpacing=0 cellPadding=0 width=1003 background=index.files/copyright-bg.gif border=0>
  ...
  <TR>
    ...
    <TD width=900 background="" height=1></TD>
